package Thing
{
   ...
   public class CThingAudio extends CThingState
   {
      ...
      public static function UpdateAllSounds() : void
      {
         ...
         _loc7_ = CGame.mFPS.StopProfile("AUDIO");
         if(_loc7_ >= 20)
         {
         }
      ...
      private function getPanVol() : Object
      {
         ...
         _loc1_ = _loc3_ > 4 ? 1 - Math.min(1,(_loc3_ - 4) / mAudioSize.x) : 1;
         _loc2_ = (mPosition.x - mAudioCentre.x) / mAudioSize.x;
         return {
            "vol":_loc1_,
            "pan":_loc2_
         };
