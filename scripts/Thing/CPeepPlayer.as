package Thing
{
   ...
   public class CPeepPlayer extends CThingPeep
   {
      ...
      {
         var _loc1_:CPlayerControl = null;
         mDelta.ScaleN(0.5);
         _loc1_ = ProcessControl();
         if(Boolean(_loc1_.mDeltaX) || Boolean(_loc1_.mDeltaY))
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:CThingWeapon = null;
         _loc2_ = int(mWeaponOrder.indexOf(param1.mClassID));
         ...
         _loc3_ = mWeapons[_loc2_];
         _loc3_.mUpgrade = param1.mUpgrade;
      ...
      public function NextWeapon(param1:int) : void
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:CThingWeapon = null;
         if(param1 == 0)
         {
            return;
         }
         _loc2_ = int(mWeapons.indexOf(mSelectedWeapon));
         _loc3_ = 1;
         while(_loc3_ < mWeapons.length)
         {
            _loc4_ = mWeapons[(_loc2_ + param1 * _loc3_ + mWeapons.length) % mWeapons.length];
            if(!_loc4_.mWeaponEmpty)
            {
               SelectWeapon(_loc4_);
               return;
            }
      ...
      public function State_CONTROL() : void
      {
         ...
         else if(mSelectedWeapon.mWeaponEmpty)
         {
            NextWeapon(-1);
         }
      ...
      public function PickupAmmo(param1:CThingPickup) : void
      {
         ...
         {
            _loc8_ = _loc4_.mPickupProbability;
            if(_loc8_)
            {
               _loc3_.push({
                  "weapon":_loc4_,
      ...
      {
         ObjectRender();
         if(Boolean(mcDrawInfo) && CHUD.mDraw)
         {
