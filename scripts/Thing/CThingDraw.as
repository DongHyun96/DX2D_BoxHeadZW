package Thing
{
   ...
   public class CThingDraw extends CThingAudio
   {
      ...
      {
         return idExists(param1,mCacheList) ? ActivateMCOmni(param1) : false;
      }
      ...
      {
         var _loc3_:CSpriteMCAnimation = null;
      ...
      {
         return idExists(param1,mCacheList) ? ActivateSpriteSheet(param1) : false;
      }
      
      public function GenSmokeExists(param1:String) : Boolean
      {
         return idExists(param1,mCacheList) ? ActivateGenSmoke(param1) : false;
      }
      ...
      {
         return idExists(param1,mCacheList) ? ActivateGenFire(param1) : false;
      }
      
      public function MCAnimationExists(param1:String) : Boolean
      {
         return idExists(param1,mCacheList) ? ActivateMCAnimation(param1) : false;
      }
      ...
      {
         return idExists(param1,mCacheList) ? ActivateGenExplosion(param1) : false;
      }
