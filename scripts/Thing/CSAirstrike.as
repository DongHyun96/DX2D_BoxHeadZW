package Thing
{
   ...
   public class CSAirstrike extends CThingShot
   {
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:CExplosion = null;
         var _loc3_:Array = null;
         var _loc4_:CThingV3 = null;
         var _loc5_:CThingV3 = null;
         var _loc6_:CThingV3 = null;
         var _loc7_:CThingV3 = null;
         var _loc8_:int = 0;
         var _loc9_:CThingV3 = null;
         var _loc10_:int = 0;
         Process_Beacon();
         if(--mStrikeCount == 0)
         {
            ...
            _loc5_ = mAngle.mDelta.RotateZ(Math.PI / 2).ScaleN(-mStrikeRange / 2 * mStrikeSpread);
            ...
            while(_loc8_ < mStrikeRange)
            {
               ...
               {
                  if(!(mMap.GetCellAt(mPosition.x + _loc9_.x,mPosition.y + _loc9_.y).mCollide & eWMCCollideType.SOLID))
                  {
      ...
      public function Process_Normal() : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:CThingAngle = null;
         var _loc7_:int = 0;
         var _loc8_:CThingV3 = null;
         if(--mStrikeCount == 0)
         {
            mAlpha = 1;
            _loc1_ = 0;
            ...
            while(_loc4_ <= mStrikeRange)
            {
               ...
               while(_loc7_)
               {
                  ...
                  if(!(mMap.GetCellAt(mPosition.x + _loc8_.x,mPosition.y + _loc8_.y).mCollide & eWMCCollideType.SOLID))
                  {
                     _loc3_.push(_loc1_++);
         ...
         if(--mStrikeCount == 0)
         {
            ...
            while(_loc3_ <= mStrikeRange)
            {
               ...
               while(_loc6_)
               {
                  ...
                  if(!(mMap.GetCellAt(mPosition.x + _loc7_.x,mPosition.y + _loc7_.y).mCollide & eWMCCollideType.SOLID))
                  {
