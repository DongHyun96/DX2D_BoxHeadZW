package Thing
{
   ...
   public class CThingMap extends CThingDraw
   {
      ...
      public function DistanceToCell(param1:CWMCell) : Number
      {
         ...
         _loc2_ = param1.mapX + 0.5 - mPosition.x;
         _loc3_ = param1.mapY + 0.5 - mPosition.y;
      ...
      public function GetRandomInitCell(param1:int = 65535) : CWMCell
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:CWMCell = null;
         _loc2_ = 100;
         while(_loc2_)
         {
            _loc3_ = int(RandomInt(mMap.mWidth));
            _loc4_ = int(RandomInt(mMap.mHeight));
            _loc5_ = mMap.QGetCellAt(_loc3_,_loc4_);
            if((_loc5_.mCollide & param1) == 0)
            {
               return _loc5_;
            }
            _loc2_--;
      ...
      public function SetCollide(param1:CWMCell, param2:uint) : void
      {
         ...
         mCollideCell = param1;
         mCollideCell.mCollide |= mCollideFlags;
      }
      ...
      public function GetThingsAngle(param1:Number, param2:Number = 0, param3:int = 16775167, param4:int = 1) : Object
      {
         ...
         _loc6_ = mAngle.pDelta;
         _loc6_.normalize(param1);
