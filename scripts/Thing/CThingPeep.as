package Thing
{
   ...
   public class CThingPeep extends CThingControl
   {
      ...
      public function CThingPeep(param1:Object, param2:Class)
      {
         ...
         mSpeedScale = param1.mSpeedScale ? Number(param1.mSpeedScale) : 1;
         mAttackScale = param1.mAttackScale ? Number(param1.mAttackScale) : 1;
         mMass = 1;
         mAffectThreshold = 1;
      ...
      public function State_PUSH() : void
      {
         ...
         if(--mStateCount < 0)
         {
            if(Boolean(mCellCurrent.mCollide & eWMCCollideType.INVALIDANDIE) && !mDead)
            {
               mLife = -1;
            }
            if(!CheckForDeath())
