package Draw
{
   ...
   public class CSpriteBMD extends BitmapData
   {
      ...
      {
         var _loc5_:CSpriteBMD = null;
         _loc5_ = new CSpriteBMD(param1.width,param1.height);
      ...
      public static function asDisplayObject(param1:DisplayObject, param2:Number = 1, param3:Array = null) : CSpriteBMD
      {
         ...
         _loc5_ = _loc4_.width == 0 || _loc4_.height == 0 ? new CSpriteBMD(1,1) : new CSpriteBMD(_loc4_.width,_loc4_.height);
         _loc5_.mDisplacement = new Point(_loc4_.x,_loc4_.y);
         _loc6_ = new Matrix();
      ...
      public function Draw(param1:BitmapData, param2:int, param3:int, param4:Number = 1, param5:Number = 1) : void
      {
         ...
         else
         {
            ...
            param1.draw(this,new Matrix(param5,0,0,param5,param2 + mDisplacement.x * param5,param3 + mDisplacement.y * param5),mDrawColorTransform);
         }
      }
   }
}
