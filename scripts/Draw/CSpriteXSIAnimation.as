package Draw
{
   ...
   public class CSpriteXSIAnimation extends CSprite
   {
      ...
      public static function asSpriteSheet(param1:CSpriteSheet, param2:Boolean = false) : Object
      {
         ...
         var _loc4_:ShadowMaker = null;
         var _loc5_:Bitmap = null;
         var _loc6_:Bitmap = null;
         var _loc7_:Bitmap = null;
         var _loc8_:CSpriteFrame = null;
         var _loc9_:CSpriteXSIAnimation = null;
         var _loc10_:CSpriteXSIAnimation = null;
         var _loc11_:Array = null;
         var _loc12_:Array = null;
         var _loc13_:CSpriteBMD = null;
         _loc3_ = new Object();
         ...
         for each(_loc8_ in param1.mAllFrames)
         {
            ...
            _loc11_ = _loc10_.mDirections = _loc10_.mDirections ? _loc10_.mDirections : new Array();
            _loc12_ = _loc11_[_loc8_.mDirectionIndex] = _loc11_[_loc8_.mDirectionIndex] ? _loc11_[_loc8_.mDirectionIndex] : new Array();
            ...
            _loc13_ = _loc12_[_loc8_.mFrameIndex] = CSpriteBMD.asDisplayObject(_loc4_);
            _loc13_.mData.mModelInfo = FormatModelInfo(_loc8_.mModelInfo);
         }
         if(param2)
         {
      ...
      private static function FormatModelInfo(param1:Object) : Object
      {
         ...
         _loc2_ = 32 / CLSDraw.xProjection * (1 / 100);
      ...
      public function Draw(param1:CBitmapData, param2:int, param3:int, param4:uint = 0, param5:Number = 0, param6:Number = 1) : void
      {
         ...
         _loc8_ = mDirections[param4][_loc7_];
         _loc8_.Draw(param1,param2,param3,param6);
      }
