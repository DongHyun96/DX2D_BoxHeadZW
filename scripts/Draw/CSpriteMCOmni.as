package Draw
{
   ...
   public class CSpriteMCOmni extends CSprite
   {
      ...
      private function _BufferEle_PRE(param1:MovieClip, param2:Number = 0) : void
      {
         ...
         _loc3_ = ELE_FWIDTH / CLSDraw.xProjection;
         _loc4_ = ELE_FHEIGHT / CLSDraw.xProjection;
         ELE_FPLIST1 = [new CVector3(0,-_loc3_,-_loc4_),new CVector3(0,-_loc3_,_loc4_),new CVector3(0,_loc3_,_loc4_),new CVector3(0,_loc3_,-_loc4_)];
         ...
         _loc3_ = ELE_TWIDTH / CLSDraw.xProjection;
         _loc4_ = ELE_THEIGHT / CLSDraw.xProjection;
         ELE_TPLIST1 = [new CVector3(0,-_loc4_),new CVector3(0,_loc4_),new CVector3(_loc3_,_loc4_),new CVector3(_loc3_,-_loc4_)];
      ...
      {
         var _loc6_:CSpriteBMD = null;
         _loc6_ = mDirections[param4];
         _loc6_.Draw(param1,param2,param3,param5);
      }
      ...
      private function _Buffer(param1:MovieClip, param2:Number) : CSpriteBMD
      {
         ...
         _loc4_ = CLSDraw.ProjectionPoint(_loc3_.transformPoint(new Point(1 / CLSDraw.xProjection,0)));
         _loc5_ = CLSDraw.ProjectionPoint(_loc3_.transformPoint(new Point(0,1 / CLSDraw.xProjection)));
         _loc6_ = new Matrix();
         _loc7_ = _loc4_.x;
         _loc8_ = _loc5_.y;
         ...
         _loc10_ = param2 + Math.PI / 2;
         _loc11_ = new Matrix(Math.cos(_loc10_),Math.sin(_loc10_),0,1,0,0);
         _loc11_.scale(1,CLSDraw.sProjection);
