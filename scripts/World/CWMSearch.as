package World
{
   ...
   public class CWMSearch extends CWMBase
   {
      ...
      public static const a256PI:Number = 256 / (Math.PI * 2);
      ...
      {
         return param1.len > param2.len ? 1 : (param1.len < param2.len ? -1 : 0);
      }
      ...
      public function GetCells(param1:CWMSearchArea, param2:Function = null) : Array
      {
         ...
         _loc5_ = int(param1.right);
         if(param2 != null)
         {
            _loc6_ = int(param1.top);
            _loc7_ = int(param1.bottom);
            while(_loc6_ <= _loc7_)
            {
               _loc4_ = int(param1.left);
      ...
      public function _GTL_LineIntersectsRadius(param1:Number, param2:Number, param3:Number) : Boolean
      {
         ...
         _loc6_ = _GTL_ldx * param1 + _GTL_ldy * param2;
         if(_loc6_ <= 0)
         {
      ...
      public function GetCellsLine(param1:Point, param2:Point, param3:Number = 0, param4:Boolean = false) : Array
      {
         ...
         var _loc9_:CWMCell = null;
         var _loc10_:int = 0;
         var _loc11_:int = 0;
         var _loc12_:Array = null;
         var _loc13_:* = undefined;
         _GTL_Setup(param1,param2);
         _loc5_ = Math.atan2(_GTL_ldy,_GTL_ldx) * a256PI & 0xFF;
         ...
         if(param4)
         {
            ...
            {
               _loc9_ = GetCellAt(param1.x + _loc8_.x,param1.y + _loc8_.y);
               if(_loc9_.mCollide & eWMCCollideType.SOLID)
               {
                  if(_GTL_COLLIDE(_loc8_.x - _GTL_OFFLOC.x,_loc8_.y - _GTL_OFFLOC.y))
                  {
                     break;
                  }
               }
      ...
      public function _GTL_LineIntersectsLineX(param1:Number, param2:Number) : Boolean
      {
         ...
         _loc4_ = (_GTL_ldy * param1 - _GTL_ldx * param2) / -_GTL_ldy;
      ...
      public function _GTL_LineIntersectsLineY(param1:Number, param2:Number, param3:Number = 0, param4:Number = 1) : Boolean
      {
         ...
         _loc5_ = param1 / _GTL_ldx;
         if(_loc5_ < 0 || _loc5_ > 1)
         {
            return false;
         }
         _loc6_ = (_GTL_ldy * param1 - _GTL_ldx * param2) / _GTL_ldx;
      ...
      public function QLineOfSight(param1:Point, param2:Point, param3:Number = 0) : Boolean
      {
         ...
         var _loc8_:CWMCell = null;
         _GTL_Setup(param1,param2);
         _loc4_ = Math.atan2(_GTL_ldy,_GTL_ldx) * a256PI & 0xFF;
         _loc5_ = mSearchLines[_loc4_];
         _loc6_ = Math.sqrt(_GTL_ldv) + param3;
         for each(_loc7_ in _loc5_)
         {
            _loc8_ = GetCellAt(param1.x + _loc7_.x,param1.y + _loc7_.y);
            if(_loc8_.mCollide & eWMCCollideType.SOLID)
            {
               if(_GTL_COLLIDE(_loc7_.x - _GTL_OFFLOC.x,_loc7_.y - _GTL_OFFLOC.y))
               {
                  return false;
               }
            }
