package World
{
   ...
   public class CWMCNavigation extends CWMCNeighbours
   {
      ...
      {
         var _loc2_:CWMCNavigation = null;
      ...
      {
         var _loc3_:int = 0;
         var _loc4_:CWMCNavigation = null;
         var _loc5_:String = null;
         var _loc6_:CWMCNavigation = null;
         moveBits = 0;
         ...
         {
            _loc6_ = mNeighbours[_loc5_];
            if(_loc6_.mNavIndex <= _loc3_)
            {
      ...
      {
         return nNorthEast.mCollide < COLLIDEINDEXp1 && Boolean(moveBits & bN_E);
      }
      ...
      {
         return nNorthWest.mCollide < COLLIDEINDEXp1 && Boolean(moveBits & bN_W);
      }
      ...
      {
         return nSouthEast.mCollide < COLLIDEINDEXp1 && Boolean(moveBits & bS_E);
      }
      
      private function CanMove_SW() : Boolean
      {
         return nSouthWest.mCollide < COLLIDEINDEXp1 && Boolean(moveBits & bS_W);
      }
      
      private function SortOnNavIndex(param1:CWMCNavigation, param2:CWMCNavigation) : Number
      {
         return param1.mNavIndex > param2.mNavIndex ? 1 : (param1.mNavIndex < param2.mNavIndex ? -1 : 0);
      }
      ...
      public function MovableNeighbours4(param1:Boolean = true) : Array
      {
         ...
         if(param1 && Boolean(_loc2_.length))
         {
