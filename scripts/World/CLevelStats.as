package World
{
   ...
   public class CLevelStats
   {
      ...
      {
         return Math.pow(100 - Math.min(100,param1),2.5) / Math.pow(100,2.5) * (CWorld.SECONDS * 3 - 1) + 1;
      }
      ...
      {
         if((param1.mCellCurrent.mCollide & ~eWMCCollideType.PEEP) == 0)
         {
      ...
      {
         _MultipleKills = param1 < 0 ? 0 : param1;
         if(_MultipleKills)
         {
