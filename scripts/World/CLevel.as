package World
{
   ...
   public class CLevel
   {
      ...
      private function AddEdgeSpawnPosition(param1:CWMCell) : void
      {
         ...
         {
            if(!(param1.mNeighbours[_loc3_].mCollide & eWMCCollideType.SOLID))
            {
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:CSpawnPosition = null;
         _loc1_ = 20;
         while(_loc1_)
         {
      ...
      private function SetupLevels() : void
      {
         ...
         while(_loc8_ <= MAXLEVEL)
         {
            _loc9_ = null;
            _loc10_ = new Object();
            _loc10_.mSpawnCount = 0;
            _loc10_.mActiveCount = 0;
            _loc10_.mEnemys = new Array();
            _loc11_ = (_loc8_ - 1) * (1 / 20) + 1;
            _loc12_ = (_loc8_ - 1) * (1 / 20) + 1;
            if(_loc8_ >= 5)
            {
               ...
               _loc6_ = GetRatio("DEVIL",_loc13_ ? DEVILRATIO * 10 : DEVILRATIO);
      ...
      public function CreateSpawnPositions() : *
      {
         ...
         _loc2_ = int(mWorldMap.mHeight - 1);
         while(_loc2_ >= 0)
         {
            _loc1_ = int(mWorldMap.mWidth - 1);
            _loc3_ = mWorldMap.mCells[_loc2_];
            while(_loc1_ >= 0)
            {
               _loc4_ = _loc3_[_loc1_];
               if(_loc4_.mCollide == (eWMCCollideType.EDGE | eWMCCollideType.SOLID))
               {
      ...
      private function SpawnEnemy() : Boolean
      {
         ...
         var _loc4_:CSpawnPosition = null;
         var _loc5_:CThingPeep = null;
         if(mLevelInitCounter >= 0)
         {
            return false;
         }
      ...
      {
         return param1.mRandomizer > param2.mRandomizer ? 1 : (param1.mRandomizer < param2.mRandomizer ? -1 : 0);
      }
