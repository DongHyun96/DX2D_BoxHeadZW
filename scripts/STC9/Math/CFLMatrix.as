package STC9.Math
{
   ...
   public class CFLMatrix extends Matrix
   {
      ...
      {
         return param1 == 0 || !isFinite(param1) ? 0.000001 : param1;
      }
      
      public static function RemapPlane(param1:Array, param2:Array) : CFLMatrix
      {
         var _loc3_:CFLMatrix = null;
      ...
      {
         this.scale(param1 ? -1 : 1,param2 ? -1 : 1);
      }
