package STC9.Math
{
   public class CMatrix4
   {
      ...
      internal static function Translate_Matrix(param1:Number, param2:Number, param3:Number, param4:Boolean = false) : CMatrix4
      {
         var _loc5_:CMatrix4 = null;
      ...
      internal static function RotateXYZ_Matrix(param1:Number, param2:Number, param3:Number) : CMatrix4
      {
         return undefined;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc4_:CVector3 = null;
         var _loc5_:CVector3 = null;
