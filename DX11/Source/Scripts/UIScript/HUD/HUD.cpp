...
void RoundIndicators::OnRoundWaitStart()
{
...
void RoundIndicators::OnRoundWaiting(float RoundWaitTime)
{
    {
...
void RoundIndicators::OnRoundStart(int RoundNumber)
{
...
void RoundIndicators::OnRounding()
{
...
void RoundIndicators::OnGameOver()
{
    RoundNumberTimer = 0.f;
    RoundText->SetAlpha(1.f);
